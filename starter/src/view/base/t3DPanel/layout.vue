...
import t3D10Auto from "./10Auto.vue";
import t3D11Static from "./11Static.vue";
import t3D12GyroTest from "./12GyroTest.vue";
import t3D1Matrix from "./1Matrix.vue";
import t3D2Hive from "./2Hive.vue";
import t3D3Unity from "./3Unity.vue";
import t3D4Hover from "./4Hover.vue";
import t3D5AniApart from "./5AniApart.vue";
import t3D6AniUnity from "./6AniUnity.vue";
import t3D7HiveApart from "./7HiveApart.vue";
import t3D8GyroApart from "./8GyroApart.vue";
import t3D9GyroUnity from "./9GyroUnity.vue";
...
<style lang="less">
  ...
  .t3DPanel-demo{
    .tabs-wrap {.poa; inset:0; bottom:auto; padding:0 0 0 20px; .bgc(@bld1);
