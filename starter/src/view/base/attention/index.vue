...
const {proxy:{$tMessage,$tMessageCloseAll,$tNotify,$tNotifyCloseAll,$tToast,$tToastClose,$tFlash,$tFlashClose}}=getCurrentInstance();
const {$data,$attentionConfig,$aMessage,$aNotification,$aToast,$aFlash,$aDispatcher}= inject('$global');
