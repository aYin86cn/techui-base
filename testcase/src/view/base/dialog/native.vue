...
const state=reactive({
  ...
  group:[
    ...
    {label:"自定义宽度 vw",show:false,config:{width:'40vw'}},
    {label:"自定义宽度px",show:false,config:{width:500}},
    {label:"自定义top",show:false,config:{top:-200}},
    {label:"自定义top vh",show:false,config:{top:'30vh'}},
  ...
  <div class="dialog-demo-wrap">
    ...
    <div class="demo-inner">
      ...
      <div class="trigger-item" v-for="(item,index) in state.group">
        ...
        <TuiDialogNative :title="item.label" v-model="item.show" v-bind="{
            ...config,
            ...item.config, 
            typedConfig:{
              ...config.typedConfig,
      ...
      <div class="trigger-item">
        ...
        <TuiDialogNative v-model="multGroup.children[0].show" v-bind="{
        ...
        <TuiDialogNative v-model="multGroup.children[1].show" v-bind="{
