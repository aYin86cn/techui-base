...
const basicStats = ref([
  ...
  { name: 'Navigation (导航组件)', count: 9, icon: '🧭' },
  { name: 'RollingGroup (滚动组)', count: 15, icon: '📜' },
...
<template>
  <div class="tech-ui-avd-overview">
    ...
    <header class="header-section">
      ...
      <div class="desc">
        当前统计共包含 {{ totalCount }} 个组件，排除各个item组件后核心组件数 100+。其中包含 6 个高级组件（1免费/5付费），其余均为免费组件。
      </div>
      <div class="desc">
    ...
    <div class="layout-column">
      ...
      <section class="config-section">
        ...
        <div class="config-grid">
          ...
          <!-- 代码演示 -->
          <TuiTyped type="invert" class="code-block">
  ...
  .layout-column { display: flex; flex-direction: column; gap: 60px;
    ...
    .config-section {
      ...
      .code-block {
        ...
        .code-title {.bdb(var(--tui-type-bd)); padding: 8px 16px; font-size: 0.85rem; }
